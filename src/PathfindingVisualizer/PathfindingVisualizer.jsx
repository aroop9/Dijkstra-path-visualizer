...
export default class PathfindingVisualizer extends Component {
  ...
  visualizeDijkstra() {
    this.setState({ topMessage: "Creator : Aroop" });
  ...
  render() {
    ...
    } else if (topMessage === "Creator : Aroop") {
      ...
      <div className="pathfindingVisualizer">
        <div className="container">
          <div className="heading">
            <h2 onClick={showPopUp}>Shortest Path Search Visualizer !</h2>
            <h2>{topMessage}</h2>
          </div>
